...
# Creation Date and Time:  Tue Jul 13 15:53:15 2021
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 4.190100e-02
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 1.468160e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 5.016490e-01
Vprtstp: iteration = 0
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 9.467110e-01
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 1.161852e+00
...
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 3.350000e-03
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.027375
Vpmg_fillco:  done filling coefficient arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 3.643550e-01
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (129, 129, 129)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 4.131800e-02
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (065, 065, 065)
Vbuildops: Galer: (033, 033, 033)
Vbuildops: Galer: (017, 017, 017)
Vbuildops: Galer: (009, 009, 009)
Vbuildops: Galer: (005, 005, 005)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 1.414620e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 2.031449e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 9.220880e-01
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 1.130157e+00
Vpmg_setPart:  lower corner = (11.34, 11.64, 10.82)
Vpmg_setPart:  upper corner = (72.42, 72.12, 72.95)
...
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 3.310000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 0.000000e+00
...
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 3.459922e+00
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Tue Jul 13 15:53:18 2021
